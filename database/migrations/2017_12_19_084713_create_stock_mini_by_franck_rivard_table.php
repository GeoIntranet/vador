...
class CreateStockMiniByFranckRivardTable extends Migration {
	...
	public function up()
	{
		Schema::create('stock_mini_by_franck_rivard', function(Blueprint $table)
		{
	...
	{
		Schema::drop('stock_mini_by_franck_rivard');
	}
