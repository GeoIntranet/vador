...
@section('content')
    ...
    <div class="row locatorContainer pad5 ">
        ...
        <div class="small-12 medium-10 large-10 column SubContainer ">
                ...
                <div class="column bgW ">
                    <div class="row align-middle pad5">
                        ...
                        <div class="column medium-11 ">
                            <h4 class="googleB">Sortie Multi ID</h4>
                            <p>
                                Cette page permet de sortir les ID selectionés précédements. .
                            </p>
                        </div>
                    </div>
                </div>
            ...
            {!! Form::open(['action' => 'locatorController@postMultiOut', 'method' => 'post']) !!}
