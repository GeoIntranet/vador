        ...
        <div class="row padr10">
            <div class="medium-12  column  mContainer ">
                ...
                <div class="row">
                    ...
                    <p>  Lorsque vous rentrez vos horaires, vous avez plusieurs possibilités. </p>
                    <ul class="c">
                        <li>
        ...
        <div class="row align-">
            <div class="medium-12 column">
                ...
                <div class="row">
                    <div class="medium-12 column" >
                        <h3>
                            <i class="fa fa-angle-right dk"></i> Le
                            <span class="emp">
                    ...
                    <div class="row ">
                        ...
                        <div class="medium-6 columns">
                            <label>Commentaire
                              {{ Form::text('commentaire', '', ['class' => 'horaireInput '.$warningC.'','']) }}
                            </label>
                        </div>
                    </div>
                    <hr/>
