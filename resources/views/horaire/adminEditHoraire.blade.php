    ...
    <div class="small-12 medium-12  large-8 column mContainer">
        ...
        <div class="row align-">
            <div class="medium-12 column">
                <div class="row">
                    <div class="medium-12 column">
                        <h2 class="googleB"> <i class="fa fa-clock-o"></i> HORAIRE - administration</h2>
                    </div>
                </div>
               <div class="row">
                   <div class="medium-12 column" >
                    ...
                    {!! Form::open( [ 'action' => array('HoraireAdmController@Store'), 'method' => 'POST']) !!}
                        <input type="hidden" name="_token" value="{!! csrf_token() !!}">
                        {{ Form::hidden('ht',$htaff) }}
                        {{ Form::hidden('dtr',$next->format('Y-m-d')) }}
                        {{ Form::hidden('u',$user) }}
                        {{ Form::hidden('id',($id == 0) ? 'xx' : $id) }}
                    ...
                    <div class="row ">
                        ...
                        <div class="medium-6 columns">
                            <label>Commentaire
                              {{ Form::text('commentaire', '', ['class' => 'horaireInput '.$warningC.'','placeholder' => 'Raison de l\'absence']) }}
                            </label>
                        </div>
                    </div>
                    <hr/>
                    ...
                    <div class="row ">
                        @if($id <> 0)
                            ...
                            <div class="medium-2 column">
                                <br/>
                                <a class="button alert" href="{{action('HoraireAdmController@Delete', [ 'id' => $id])}}"><i class="fa fa-bitbucket"></i> Delete</a>
                            </div>
                        @else
                            <div class="medium-2 column">
                               &nbsp
                        ...
                        <div class="medium-10 column right">
                        <br/>
