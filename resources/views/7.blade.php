    ...
    <div class="row">
        <div class="top-bar-left">
            <ul class="dropdown menu" data-dropdown-menu>
                <li class="menu-text googleTi">Yeti Store</li>
...
<div class="row">
    <div class="column medium-8" >
        {!! Form::open(['url' => '/test/bbcode', 'class' => 'form-horizontal']) !!}
...
<script type="text/javascript" src="{{asset('js/bbc.min.js')}}"></script>
<script>
    $(document).ready(function() {
        var wbbOpt = {
            buttons: "bold,italic,underline,fontcolor,|,bullist,fontsize,table, code,quote"
        }
